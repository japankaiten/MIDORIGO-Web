...
const english: LocaleContent = {
  ...
  home: {
    ...
    ctaAvailability: 'App availability',
...
const translations: Record<LanguageCode, LocaleContent> = {
  ...
  id: shallowTranslate(english, {
    ...
    home: {
      ...
      ctaAvailability: 'Ketersediaan aplikasi',
  ...
  my: shallowTranslate(english, {
    ...
    home: {
      ...
      ctaAvailability: 'အက်ပ်ရရှိနိုင်မှု',
  ...
  vi: shallowTranslate(english, {
    ...
    home: {
      ...
      ctaAvailability: 'Tình trạng phát hành',
  ...
  es: shallowTranslate(english, {
    ...
    home: {
      ...
      ctaAvailability: 'Disponibilidad de la app',
