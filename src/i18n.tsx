...
const english: LocaleContent = {
  ...
  home: {
    eyebrow: 'Circular economy app for residents in Japan',
    title: 'Trade locally. Reuse more.',
    tagline: 'Community listings with local waste guidance.',
    intro:
      'MIDORIGO brings together second-hand listings, jobs, homes, events, help requests, cars, and municipality-oriented waste support in one place.',
    ...
    features: [
      { icon: 'market', title: 'Second-hand marketplace', text: 'Post, trade, or give away useful items locally.' },
      { icon: 'briefcase', title: 'Local jobs', text: 'Find work and service opportunities in your area.' },
      { icon: 'home', title: 'Real estate', text: 'Browse local housing and property posts.' },
      { icon: 'calendar', title: 'Events and help', text: 'Share events, ask for help, and support neighbors.' },
      { icon: 'car', title: 'Cars and mobility', text: 'Post or browse local vehicle and mobility listings.' },
      { icon: 'scan', title: 'Waste scanner', text: 'Use AI-assisted identification for local disposal guidance.' },
      { icon: 'calendar', title: 'Pickup calendar', text: 'Keep collection days clear and easy to check.' },
      { icon: 'map', title: 'Disposal rules', text: 'See waste rules based on your city or area.' },
      { icon: 'recycle', title: 'Recycling facilities', text: 'Find nearby recycling and special drop-off points.' },
      { icon: 'language', title: 'Japanese and English', text: 'Switch languages for listings, rules, and reminders.' },
    ],
...
const translations: Record<LanguageCode, LocaleContent> = {
  ...
  ja: shallowTranslate(english, {
    ...
    home: {
      ...
      title: '地域でつなぐ。再利用を広げる。',
      tagline: 'コミュニティ掲載と地域のごみ案内。',
      intro: 'MIDORIGOは、中古品、仕事、住まい、イベント、助け合い、車、そして自治体向けごみサポートをひとつにまとめます。',
      ...
      features: [
        { icon: 'market', title: '中古マーケットプレイス', text: '使える物を地域で売買・譲渡できます。' },
        { icon: 'briefcase', title: '地域の仕事', text: '地域の人や団体が掲載する近隣の仕事やサービス機会を見つけられます。' },
        { icon: 'home', title: '不動産', text: '地域の住まいや物件情報を探せます。' },
        { icon: 'calendar', title: 'イベントと助け合い', text: 'イベント共有や近隣サポートに使えます。' },
        { icon: 'car', title: '車とモビリティ', text: '地域の車両や移動関連の掲載を見つけられます。' },
        { icon: 'scan', title: 'ごみスキャナー', text: 'AI支援で地域の分別案内を確認できます。' },
        { icon: 'calendar', title: '収集カレンダー', text: '収集日を見やすく確認できます。' },
        { icon: 'map', title: '分別ルール', text: '地域設定に応じたごみルールを見られます。' },
        { icon: 'recycle', title: 'リサイクル施設', text: '近くの回収・持ち込み先を探せます。' },
        { icon: 'language', title: '日本語と英語', text: '掲載や案内を日英で切り替えられます。' },
      ],
  ...
  ko: shallowTranslate(english, {
    ...
    home: {
      eyebrow: '일본 거주자를 위한 순환경제 앱',
      title: '가까이 거래하고, 더 오래 재사용하세요.',
      tagline: '커뮤니티 게시물과 지역 폐기물 안내.',
      intro: 'MIDORIGO는 중고품, 일자리, 주거, 이벤트, 도움 요청, 차량, 그리고 지자체 중심 폐기물 지원을 한곳에 모읍니다.',
      ...
      features: [
        { icon: 'market', title: '중고 마켓플레이스', text: '쓸 만한 물건을 지역에서 올리고 거래할 수 있습니다.' },
        { icon: 'briefcase', title: '지역 일자리', text: '지역 개인과 단체가 올린 근처 일자리와 서비스 기회를 찾을 수 있습니다.' },
        { icon: 'home', title: '부동산', text: '지역의 주거 및 부동산 게시물을 볼 수 있습니다.' },
        { icon: 'calendar', title: '이벤트와 도움', text: '이벤트를 공유하고 이웃과 도움을 주고받을 수 있습니다.' },
        { icon: 'car', title: '차량 및 모빌리티', text: '지역 차량 및 이동 관련 게시물을 둘러볼 수 있습니다.' },
        { icon: 'scan', title: '폐기물 스캐너', text: 'AI 보조 식별로 지역 배출 안내를 확인할 수 있습니다.' },
        { icon: 'calendar', title: '수거 캘린더', text: '수거일을 쉽고 빠르게 확인할 수 있습니다.' },
        { icon: 'map', title: '배출 규칙', text: '도시나 지역에 맞는 폐기물 규칙을 볼 수 있습니다.' },
        { icon: 'recycle', title: '재활용 시설', text: '가까운 재활용 및 반입 시설을 찾을 수 있습니다.' },
        { icon: 'language', title: '일본어와 영어', text: '게시물과 안내를 두 언어로 전환할 수 있습니다.' },
      ],
  ...
  zh: shallowTranslate(english, {
    ...
    home: {
      eyebrow: '面向日本居民的循环经济应用',
      title: '本地交易。更多再利用。',
      tagline: '社区发布与本地垃圾指引。',
      intro: 'MIDORIGO 将二手物品、工作、住房、活动、求助、汽车和自治体导向的垃圾支持整合到一个地方。',
      ...
      features: [
        { icon: 'market', title: '二手市场', text: '发布仍可使用的物品，进行本地交易或转赠。' },
        { icon: 'briefcase', title: '本地工作', text: '查找社区个人和组织发布的附近工作与服务机会。' },
        { icon: 'home', title: '房产', text: '查看本地住房和房产信息。' },
        { icon: 'calendar', title: '活动与互助', text: '分享活动、求助并联系附近居民。' },
        { icon: 'car', title: '汽车与出行', text: '浏览本地车辆和出行相关信息。' },
        { icon: 'scan', title: '垃圾扫描', text: '使用 AI 辅助识别查看本地处理指引。' },
        { icon: 'calendar', title: '收集日历', text: '快速查看垃圾收集日期。' },
        { icon: 'map', title: '投放规则', text: '查看与你所在地区对应的垃圾规则。' },
        { icon: 'recycle', title: '回收设施', text: '查找附近回收和特殊投放地点。' },
        { icon: 'language', title: '日语和英语', text: '在两种语言之间切换查看发布和指引。' },
      ],
  ...
  id: shallowTranslate(english, {
    ...
    home: {
      eyebrow: 'Aplikasi ekonomi sirkular untuk warga di Jepang',
      title: 'Transaksi lokal. Pakai lagi lebih banyak.',
      tagline: 'Listing komunitas dengan panduan sampah lokal.',
      intro: 'MIDORIGO menyatukan barang bekas, pekerjaan, hunian, acara, permintaan bantuan, mobil, dan dukungan sampah berbasis pemerintah daerah dalam satu tempat.',
      ...
      features: [
        { icon: 'market', title: 'Marketplace barang bekas', text: 'Posting barang yang masih layak untuk jual beli atau giveaway lokal.' },
        ...
        { icon: 'home', title: 'Properti', text: 'Lihat posting perumahan dan properti lokal.' },
        { icon: 'calendar', title: 'Acara dan bantuan', text: 'Bagikan acara dan saling bantu dengan warga sekitar.' },
        { icon: 'car', title: 'Mobil dan mobilitas', text: 'Telusuri listing kendaraan dan mobilitas lokal.' },
        { icon: 'scan', title: 'Pemindai sampah', text: 'Gunakan AI untuk melihat panduan pembuangan lokal.' },
        { icon: 'calendar', title: 'Kalender pengambilan', text: 'Cek jadwal pengumpulan sampah dengan cepat.' },
        { icon: 'map', title: 'Aturan pembuangan', text: 'Lihat aturan sampah sesuai kota atau area Anda.' },
        { icon: 'recycle', title: 'Fasilitas daur ulang', text: 'Temukan titik daur ulang dan drop-off terdekat.' },
        { icon: 'language', title: 'Jepang dan Inggris', text: 'Ganti bahasa untuk listing dan panduan.' },
      ],
  ...
  hi: shallowTranslate(english, {
    ...
    home: {
      eyebrow: 'जापान के निवासियों के लिए सर्कुलर इकोनॉमी ऐप',
      title: 'स्थानीय लेनदेन। ज़्यादा पुनः उपयोग।',
      tagline: 'कम्युनिटी लिस्टिंग और स्थानीय कचरा मार्गदर्शन।',
      intro: 'MIDORIGO सेकंड-हैंड सामान, नौकरियाँ, घर, इवेंट, मदद के अनुरोध, कारें और नगरपालिका-उन्मुख कचरा सहायता को एक जगह लाता है।',
      ...
      features: [
        { icon: 'market', title: 'सेकंड-हैंड मार्केटप्लेस', text: 'उपयोग योग्य वस्तुओं को स्थानीय ट्रेड या giveaway के लिए सूचीबद्ध करें।' },
        ...
        { icon: 'home', title: 'रियल एस्टेट', text: 'स्थानीय आवास और संपत्ति पोस्ट देखें।' },
        { icon: 'calendar', title: 'इवेंट और मदद', text: 'इवेंट साझा करें और पड़ोसियों से सहयोग पाएँ।' },
        { icon: 'car', title: 'कार और मोबिलिटी', text: 'स्थानीय वाहन और मोबिलिटी लिस्टिंग देखें।' },
        { icon: 'scan', title: 'कचरा स्कैनर', text: 'AI-सहायता से स्थानीय निपटान मार्गदर्शन देखें।' },
        { icon: 'calendar', title: 'पिकअप कैलेंडर', text: 'कलेक्शन दिवस जल्दी से देखें।' },
        { icon: 'map', title: 'निपटान नियम', text: 'अपने शहर या क्षेत्र के अनुसार कचरा नियम देखें।' },
        { icon: 'recycle', title: 'रिसाइक्लिंग सुविधाएँ', text: 'पास के रीसाइक्लिंग और ड्रॉप-ऑफ स्थान खोजें।' },
        { icon: 'language', title: 'जापानी और अंग्रेज़ी', text: 'लिस्टिंग और मार्गदर्शन के लिए भाषाएँ बदलें।' },
      ],
  ...
  my: shallowTranslate(english, {
    ...
    home: {
      eyebrow: 'ဂျပန်နေထိုင်သူများအတွက် စက်ဝိုင်းစီးပွားရေး အက်ပ်',
      title: 'ဒေသတွင်း အရောင်းအဝယ်။ ပိုမိုပြန်သုံးခြင်း။',
      tagline: 'အသိုင်းအဝိုင်း listing များနှင့် ဒေသအမှိုက်လမ်းညွှန်။',
      intro: 'MIDORIGO သည် အသုံးပြုပြီးပစ္စည်းများ၊ အလုပ်များ၊ အိမ်ရာများ၊ ပွဲများ၊ အကူအညီတောင်းဆိုမှုများ၊ ကားများနှင့် မြို့နယ်အခြေပြု အမှိုက်အထောက်အပံ့ကို တစ်နေရာတည်းတွင် စုစည်းပေးသည်။',
      ...
      features: [
        { icon: 'market', title: 'အသုံးပြုပြီးဈေးကွက်', text: 'အသုံးပြုနိုင်သေးသောပစ္စည်းများကို ဒေသတွင်းအရောင်းအဝယ် သို့မဟုတ် အခမဲ့ပေးရန် တင်နိုင်သည်။' },
        ...
        { icon: 'home', title: 'အိမ်ခြံမြေ', text: 'ဒေသတွင်း အိမ်ရာနှင့် ပိုင်ဆိုင်မှု post များကို ကြည့်နိုင်သည်။' },
        { icon: 'calendar', title: 'ပွဲများနှင့် အကူအညီ', text: 'ပွဲများကို မျှဝေပြီး အနီးအနားနှင့် အကူအညီပေးခံနိုင်သည်။' },
        { icon: 'car', title: 'ကားနှင့် မိုဘိုင်းတီ', text: 'ဒေသတွင်း ယာဉ်နှင့် သယ်ယူပို့ဆောင်ရေး listing များကို ကြည့်နိုင်သည်။' },
        { icon: 'scan', title: 'အမှိုက်စကင်နာ', text: 'AI ကူညီမှုဖြင့် ဒေသစွန့်ပစ်လမ်းညွှန်ကို ကြည့်နိုင်သည်။' },
        { icon: 'calendar', title: 'သိမ်းယူရက်ပြက္ခဒိန်', text: 'စုဆောင်းရက်များကို လွယ်ကူစွာ စစ်ဆေးနိုင်သည်။' },
        { icon: 'map', title: 'စွန့်ပစ်စည်းမျဉ်း', text: 'သင့်ဒေသနှင့် ကိုက်ညီသော အမှိုက်စည်းမျဉ်းကို ကြည့်နိုင်သည်။' },
        { icon: 'recycle', title: 'ပြန်လည်အသုံးပြုစင်တာများ', text: 'အနီးရှိ recycling နှင့် drop-off နေရာများကို ရှာနိုင်သည်။' },
        { icon: 'language', title: 'ဂျပန်နှင့် အင်္ဂလိပ်', text: 'listing နှင့် လမ်းညွှန်များကို ဘာသာပြောင်းလဲကြည့်နိုင်သည်။' },
      ],
  ...
  vi: shallowTranslate(english, {
    ...
    home: {
      eyebrow: 'Ứng dụng kinh tế tuần hoàn cho cư dân tại Nhật Bản',
      title: 'Giao dịch gần hơn. Tái sử dụng nhiều hơn.',
      tagline: 'Tin đăng cộng đồng cùng hướng dẫn rác thải địa phương.',
      intro: 'MIDORIGO tập hợp đồ cũ, việc làm, nhà ở, sự kiện, yêu cầu trợ giúp, xe cộ và hỗ trợ rác thải theo chính quyền địa phương trong một nơi.',
      ...
      features: [
        { icon: 'market', title: 'Chợ đồ cũ', text: 'Đăng đồ còn dùng được để giao dịch hoặc tặng lại tại địa phương.' },
        ...
        { icon: 'home', title: 'Bất động sản', text: 'Xem tin nhà ở và bất động sản địa phương.' },
        { icon: 'calendar', title: 'Sự kiện và trợ giúp', text: 'Chia sẻ sự kiện và nhận hỗ trợ từ cư dân xung quanh.' },
        { icon: 'car', title: 'Xe cộ và di chuyển', text: 'Xem các tin xe cộ và di chuyển tại địa phương.' },
        { icon: 'scan', title: 'Trình quét rác', text: 'Dùng AI hỗ trợ để xem hướng dẫn xử lý địa phương.' },
        { icon: 'calendar', title: 'Lịch thu gom', text: 'Kiểm tra nhanh ngày thu gom rác.' },
        { icon: 'map', title: 'Quy định xử lý', text: 'Xem quy định rác thải theo thành phố hoặc khu vực.' },
        { icon: 'recycle', title: 'Cơ sở tái chế', text: 'Tìm điểm tái chế và tiếp nhận gần bạn.' },
        { icon: 'language', title: 'Tiếng Nhật và tiếng Anh', text: 'Chuyển ngôn ngữ cho tin đăng và hướng dẫn.' },
      ],
  ...
  es: shallowTranslate(english, {
    ...
    home: {
      eyebrow: 'App de economía circular para residentes en Japón',
      title: 'Comercia localmente. Reutiliza más.',
      tagline: 'Publicaciones comunitarias con orientación local de residuos.',
      intro: 'MIDORIGO reúne artículos de segunda mano, empleos, viviendas, eventos, solicitudes de ayuda, autos y apoyo de residuos orientado al municipio en un solo lugar.',
      ...
      features: [
        { icon: 'market', title: 'Mercado de segunda mano', text: 'Publica objetos útiles para intercambio local o regalo.' },
        ...
        { icon: 'home', title: 'Bienes raíces', text: 'Consulta publicaciones locales de vivienda y propiedades.' },
        { icon: 'calendar', title: 'Eventos y ayuda', text: 'Comparte eventos y encuentra apoyo de residentes cercanos.' },
        { icon: 'car', title: 'Autos y movilidad', text: 'Explora anuncios locales de vehículos y movilidad.' },
        { icon: 'scan', title: 'Escáner de residuos', text: 'Usa IA para ver orientación local de desecho.' },
        { icon: 'calendar', title: 'Calendario de recogida', text: 'Consulta rápidamente los días de recogida.' },
        { icon: 'map', title: 'Reglas de desecho', text: 'Mira las reglas de residuos según tu ciudad o zona.' },
        { icon: 'recycle', title: 'Instalaciones de reciclaje', text: 'Encuentra puntos cercanos de reciclaje y entrega.' },
        { icon: 'language', title: 'Japonés e inglés', text: 'Cambia de idioma para publicaciones y orientación.' },
      ],
